...
const Header: React.FC = () => {
	...
	const handleDropdown = (dropdownName: string) => {
			...
			openDropdown === dropdownName ? setOpenDropdown('') :
		...
		<header className='mainHeader' data-testid='mainHeader'>
			<nav className='nav'>
				...
				<div className='mainHeadBtns'>
					{
						!searchInputIsOpen ? <Fragment>
							<button type='button' className='addTeamBtn' onClick={() => setOpenModal('addTeamModal')}>
								<img
							...
							<button type='button' className='upgradeBtn' onClick={() => setOpenModal('upgradeModal')}>
								Upgrade Now
							</button>
							<span
								role='button'
					...
					<div className='plusContainer'>
						<div
							...
							className={
									...
									openDropdown !== 'plusDropdown' ? 'plus' :
									'whitePlus'
							}
